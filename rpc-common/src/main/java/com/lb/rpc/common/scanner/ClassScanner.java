package com.lb.rpc.common.scanner;
 ...
 * 类扫描器基础工具类
 * <p>
 * 该类提供了扫描指定包下所有类文件的通用功能，支持从文件系统和Jar包中
 * 发现类文件。是RPC框架中服务发现和注解处理的基础工具。
 * </p>
 *
 * <p>主要功能：</p>
 * <ul>
 *   <li>递归扫描指定包及其子包下的所有类</li>
 *   <li>支持从文件系统（开发环境）中扫描类</li>
 *   <li>支持从JAR包（生产环境）中扫描类</li>
 *   <li>自动处理包名到路径的转换</li>
 *   <li>过滤非.class文件，只返回有效的类名</li>
 * </ul>
 *
 * <p>应用场景：</p>
 * <ul>
